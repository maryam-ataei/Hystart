...
static void bictcp_acked(struct sock *sk, const struct ack_sample *sample)
{
    ...
    if (t == 1) {
        ...
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): Increase cwnd: $%u\n", port, desport, tp->snd_cwnd_cnt);
        /////////////new changes/////////////////////////////////////////////////////////////////
        ...
        /////////////new changes/////////////////////////////////////////////////////////////////
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): pkt_loss: $%d\n", port, desport, tp->lost_out);
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): pkt_loss2: $%d\n", port, desport, tp->lost);
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): retrans_seg: $%d\n", port, desport, tp->retrans_out);
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): ACK_count: $%d\n", port, desport, tp->bytes_acked);
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): seq_num: $%u\n", port, desport, tp->data_segs_out);
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): seq_num1: $%u\n", port, desport, tp->segs_out);
        printk(KERN_INFO "CUBIC STATS (%hu, %hu): seg_in: $%u\n", port, desport, tp->data_segs_in);
